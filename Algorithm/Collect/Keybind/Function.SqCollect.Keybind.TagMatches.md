...
Collect into a container all the active [SqKeybind](Class.SqKeybind) instances where the tag matches the specified mask.
...
* **Parameters**:
	...
	* **_value_** `string` *The mask that should be compared with the tag of each active [SqKeybind](Class.SqKeybind) instance.*
* **Return**:
