...
Collect into a container all the active Player entity instances where the name matches the specified mask.
...
* **Parameters**:
	...
	* **_value_** `string` *The mask that should be compared with the name of each active entity instance.*
* **Return**:
