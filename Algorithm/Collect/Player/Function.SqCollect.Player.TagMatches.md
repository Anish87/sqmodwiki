...
Collect into a container all the active [SqPlayer](Class.SqPlayer) instances where the tag matches the specified mask.
...
* **Parameters**:
	...
	* **_value_** `string` *The mask that should be compared with the tag of each active [SqPlayer](Class.SqPlayer) instance.*
* **Return**:
