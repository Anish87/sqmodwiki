...
Collect into a container all the active [SqCheckpoint](Class.SqCheckpoint) instances where the tag matches the specified mask.
...
* **Parameters**:
	...
	* **_value_** `string` *The mask that should be compared with the tag of each active [SqCheckpoint](Class.SqCheckpoint) instance.*
* **Return**:
