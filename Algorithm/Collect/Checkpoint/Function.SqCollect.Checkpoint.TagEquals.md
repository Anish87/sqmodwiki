...
Collect into a container all the active [SqCheckpoint](Class.SqCheckpoint) instances that have a tag equal to the specified value.
...
* **Parameters**:
	...
	* **_value_** `string` *The string value that should be compared with the tag of each active [SqCheckpoint](Class.SqCheckpoint) instance.*
* **Return**:
