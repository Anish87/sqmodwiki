...
Collect into a container all the active [SqVehicle](Class.SqVehicle) instances where the tag matches the specified mask.
...
* **Parameters**:
	...
	* **_value_** `string` *The mask that should be compared with the tag of each active [SqVehicle](Class.SqVehicle) instance.*
* **Return**:
