...
Collect into a container all the active [SqBlip](Class.SqBlip) instances that have a tag equal to the specified value.
...
* **Parameters**:
	...
	* **_value_** `string` *The string value that should be compared with the tag of each active [SqBlip](Class.SqBlip) instance.*
* **Return**:
